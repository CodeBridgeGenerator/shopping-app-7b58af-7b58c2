...
import seederData from "./customerManagement.seeder.json";
...
const CustomerManagementSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CustomerManagementSeederDialogComponent);
