const { CustomerManagement } = require("./customerManagement.class");
const createModel = require("./customerManagement.model");
const hooks = require("./customerManagement.hooks");
...
module.exports = function (app) {
  ...
  app.use("/customerManagement", new CustomerManagement(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("customerManagement");

  // Get the schema of the collections 
  app.get("/customerManagementSchema", function (request, response) {
