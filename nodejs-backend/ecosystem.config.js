...
module.exports = {
    apps: [
        {
            // name: cwd + "-" + "shopping-app-7b58af",
            script: 'src/',
            instance_var: 'INSTANCE_ID',
            appendEnvToName: true,
            // Standard Output (console.log) will go here
            //out_file: "/home/ubuntu/app/logs/shopping-app-7b58afstg-out.log",
            // Error Output (console.error) will go here
            //error_file: "/home/ubuntu/app/logs/shopping-app-7b58af-stg-error.log",
